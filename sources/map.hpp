...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/09/09 02:01:20 by aabduvak          #+#    #+#             */
/*   Updated: 2022/09/09 05:08:34 by aabduvak         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief Maps are associative containers that store elements in a mapped fashion. Each element has a key value and a mapped value. No two mapped values can have the same key values.
 * 
 * Example:
 * std::map<std::string, std::string> obj -> obj["key"] = "value"
 * 
 * @link https://www.geeksforgeeks.org/map-associative-containers-the-c-standard-template-library-stl/ @endlink
 * @link https://cplusplus.com/reference/map/map/ @endlink
 * @link https://en.cppreference.com/w/cpp/container/map @endlink
 */
